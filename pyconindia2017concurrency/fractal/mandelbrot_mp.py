...
# Try to not pass key datastructure as params - instead try and return
# No mutable state.
def mandelbrot_calc_row(y, w, h, max_iteration = 1000, ):
    ...
    # Always return values from multiprocessing functions as much as possible
    return image_rows
...
def mandelbrot_calc_set(w, h, max_iteration=10000, output='mandelbrot_mp.png'):
    ...
    # functool.partial -> w, h, max iterations are frozen
    # and row is changed everytime
