...
class MatrixTransform(object):
    ...
    def scale(self, *scales):
        """ Scale the matrix in n dimensions where the
        matrix is an nx1 matrix """
        m, n = self._mat.getRank()
...
class MatrixTests(unittest.TestCase):
    ...
    def testAdd(self):
        m1 = MatrixFactory.fromList([[1, 2, 3], [4, 5, 6]])
        m2 = MatrixFactory.fromList([[7, 8, 9], [10, 11, 12]])        
        m3 = m1 + m2
        self.assertTrue(m3 == MatrixFactory.fromList([[8, 10, 12], [14,16,18]]))

    def testSub(self):
        m1 = MatrixFactory.fromList([[1, 2, 3], [4, 5, 6]])
        m2 = MatrixFactory.fromList([[7, 8, 9], [10, 11, 12]])        
        m3 = m2 - m1
        self.assertTrue(m3 == MatrixFactory.fromList([[6, 6, 6], [6, 6, 6]]))

    def testMul(self):
        m1 = MatrixFactory.fromList([[1, 2, 3], [4, 5, 6]])
        m2 = MatrixFactory.fromList([[7, 8], [10, 11], [12, 13]])
        self.assertTrue(m1 * m2 == MatrixFactory.fromList([[63, 69], [150, 165]]))
        self.assertTrue(m2*m1 == MatrixFactory.fromList([[39, 54, 69], [54, 75, 96], [64, 89, 114]]))

    def testTranspose(self):
		
        m1 = MatrixFactory.makeRandom(25, 30)
        zerom = MatrixFactory.makeZero(25, 30)
        m2 = m1 + zerom
    ...
    def testId(self):
        ...
        m1 = MatrixFactory.makeId(10)
        m2 = MatrixFactory.makeRandom(4, 10)
        m3 = m2*m1
